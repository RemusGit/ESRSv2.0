          ...
          <hr class="border border-2 border-success">
              ...
              <div class="col-lg-3 mb-4">
                    ...
                    <select class="form-select select2 locationClassForAll" id="contactDetailsLocationEfmsTC"  style="width: 100%;" name="getLocation" required>
                        <option value=""></option>
                    </select>
                    <label for="contactDetailsLocationEfmsTC"><i class="bi bi-asterisk text-danger" style="font-size: 10px;"></i> Location/Building</label>
                    </div>
              </div>  
              ...
              <div class="col-lg-3 mb-4">
                    <div class="form-floating">
                    <select class="form-select select2" id="contactDetailsFloorEfmsTC"  style="width: 100%;" name="getFloor" required>
                        <option value=""></option>
                    </select>
                    <label for="contactDetailsFloorEfmsTC"><i class="bi bi-asterisk text-danger" style="font-size: 10px;"></i> Floor</label>
                    </div>
              </div>  
