          ...
          <hr class="border border-2 border-success">
              ...
              <div class="col-lg-3 mb-4">
                    ...
                    <select class="form-select select2 locationClassForAll" id="contactDetailsLocationRepairItEquipment"  style="width: 100%;" name="getLocation" required>
                        <option value=""></option>
                    </select>
                    <label for="contactDetailsLocationRepairItEquipment"><i class="bi bi-asterisk text-danger" style="font-size: 9px;"></i> Location/Building</label>
                    </div>
              </div>  
              ...
              <div class="col-lg-3 mb-4">
                    <div class="form-floating">
                    <select class="form-select select2" id="contactDetailsFloorRepairItEquipment"  style="width: 100%;" name="getFloor" required>
                    </select>
                    <label for="contactDetailsFloorRepairItEquipment"><i class="bi bi-asterisk text-danger" style="font-size: 10px;"></i> Floor</label>
                    </div>
              </div>  
              ...
              <div class="col-lg-3 mb-4">
                    <div class="form-outline form-floating  w-100">
                        <div class="form-outline form-floating">
                            ...
                            <label class="form-label" style="font-size: 14px;">Name of Equipment</label>
                        </div>
                  </div>
              </div>  
