...
<div class="row mt-2 toggleSearch" @if(isset($oldData['reqCategory']) || isset($oldData['reqActionOfficer']) || isset($oldData['reqStatus']) || isset($oldData['searchEmpName']) || isset($oldData['reqDateFrom']) || isset($oldData['reqDateTo']) ) style="display: none;" @else style="display: flex;" @endif> <!--ROW FILTER 1-->
...
<form action="{{ route('filter_request') }}" method="POST">
@csrf
<div class="row toggleFilter" @if(isset($oldData['reqCategory']) || isset($oldData['reqActionOfficer']) || isset($oldData['reqStatus']) || isset($oldData['searchEmpName']) || isset($oldData['reqDateFrom']) || isset($oldData['reqDateTo']) ) style="display: flex;" @else style="display: none;" @endif> <!--ROW FILTER 2-->
...
<div class="row toggleFilter" @if(isset($oldData['reqCategory']) || isset($oldData['reqActionOfficer']) || isset($oldData['reqStatus']) || isset($oldData['searchEmpName']) || isset($oldData['reqDateFrom']) || isset($oldData['reqDateTo']) ) style="display: flex;" @else style="display: none;" @endif> <!--ROW FILTER 3-->
