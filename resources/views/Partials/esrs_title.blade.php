<div class="d-flex bd-highlight">
  ...
  <div class="p-2 flex-grow-1 bd-highlight esrsTitle">
      <div class="display-4 toAnimate" style="text-shadow: 2px 2px 4px rgba(6, 48, 23, 1); font-family: Arial, sans-serif; font-size: 40px; cursor: pointer;">ESRS<span style="font-size: 9px;">v2</span>
      </div>
